      ...
      <div id="login" class="container-fluid standard-bg">
         ...
         <div class="row header-top">
            <div class="col-lg-3 col-md-6 col-sm-12">
               <a class="main-logo" href="index.php"><img style="height:180px;" src="https://static.wixstatic.com/media/63e3de_c2ad2d98371b4fdc85fcba746ec8aab4~mv2.png/v1/fill/w_317,h_108,al_c,q_85,usm_0.66_1.00_0.01/logopaquetes.webp" class="main-logo" alt="<?php echo NOME_IPTV; ?>" title="<?php echo NOME_IPTV; ?>"></a>
            </div>
